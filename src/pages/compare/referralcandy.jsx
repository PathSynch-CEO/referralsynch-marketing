...
const VsReferralCandy = () => {
  ...
  const faqs = [
    ...
    { question: 'How does pricing compare?', answer: "ReferralCandy charges $59/month plus a 3.5% commission on all referral sales. ReferralSynch starts at $29/month with a 14-day free trial — all with zero success fees. For a business doing $10,000/month in referral sales, you'd pay $350+ with ReferralCandy vs. $69 with ReferralSynch Growth." },
